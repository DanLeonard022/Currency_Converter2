...
for (let i = 0; i < dropList.length; i++) {
    for(let currency_code in country_list){
        ...
        let selected = i == 0 ? currency_code == "AED" ? "selected" : "" : currency_code == "PHP" ? "selected" : "";
...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/612a1f66bc27536fe0568125/latest/${fromCurrency.value}`;
